...
<div
  id="drawer-example"
  class="fixed left-0 top-0 z-40 h-screen w-80 {open
    ? 'transform-none'
    : '-translate-x-full'} overflow-y-auto bg-white p-4 transition-transform dark:bg-gray-800"
  tabindex="-1"
...
>
  ...
  <p class="mb-6 text-sm text-gray-500 dark:text-gray-400">
    Supercharge your hiring by taking advantage of our <a
      href="#"
      class="text-blue-600 underline hover:no-underline dark:text-blue-500">limited-time sale</a
